...
bool CItemSharedParams::ReadParams(const XmlNodeRef& paramsNode)
{
	...
	params.pose = reader.ReadParamValue("pose", params.pose.c_str());
	...
	if (mountedParamsNode)
	{
		...
		//HoO
		pMountParams->shoot_sound_fp = mountedParamsReader.ReadParamValue("shoot_sound_fp");
		pMountParams->shoot_sound_tp = mountedParamsReader.ReadParamValue("shoot_sound_tp");
		pMountParams->shoot_recoil_anim = mountedParamsReader.ReadParamValue("shoot_recoil_anim");
		mountedParamsReader.ReadParamValue<bool>("shoot_sound_override", pMountParams->shoot_sound_override);
		//End HoO
	}
	else 
	{
