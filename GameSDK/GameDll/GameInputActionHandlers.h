...
public:
	...
	typedef TActionHandler<CCannon> TCannonActionHandler;  //HoO
	...
	ILINE TCannonActionHandler& GetCCannonActionHandler() { return m_CannonActionHandler; } // HoO
...
private:
	...
	TCannonActionHandler m_CannonActionHandler; // HoO
