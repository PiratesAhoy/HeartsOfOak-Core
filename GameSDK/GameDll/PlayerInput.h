...
private:
  ...
  bool OnActionMoveOverlayY( EntityId entityId, const ActionId& actionId, int activationMode, float value );
	...
	//HoO
	bool OnActionSpeedTime(EntityId entityId, const ActionId& actionId, int activationMode, float value);
	bool OnActionSlowTime(EntityId entityId, const ActionId& actionId, int activationMode, float value);
