...
SPhysicsRayWrapper* CCannonBall::s_pRayWrapper;
IEntityClass* CCannonBall::EntityClass = 0;

#ifdef DEBUG_CannonBall_PENETRATION
	SDebugCannonBallPenetration CCannonBall::s_debugCannonBallPenetration;
#endif

//------------------------------------------------------------------------
void CCannonBall::StaticInit()
{
	s_pRayWrapper = new SPhysicsRayWrapper;
}

//------------------------------------------------------------------------
void CCannonBall::StaticShutdown()
{
...
, m_cannonBallPierceability(0)
, m_penetrationCount(0)
, m_alive(true)
, m_ownerIsPlayer(false)
{

#if CannonBall_PENETRATION_BACKSIDE_FX_ENABLED_SP
...
//------------------------------------------------------------------------
void CCannonBall::SetParams(const SProjectileDesc& projectileDesc)
{
...
//------------------------------------------------------------------------
bool CCannonBall::CheckForPreviousHit(EntityId targetId, float& damage)
{
...
void CCannonBall::UpdateLinkedDamage(EntityId hitActorId, float totalAccumDamage)
{
	int numHitActors = m_hitActors.size();
...
//////////////////////////////////////////////////////////////////////////
void CCannonBall::EmitUnderwaterTracer(const Vec3& pos, const Vec3& destination)
{
...
//////////////////////////////////////////////////////////////////////////
void CCannonBall::DestroyAtHitPosition(const Vec3& hitPosition)
{
...
//////////////////////////////////////////////////////////////////////////
bool CCannonBall::ShouldDestroyCannonBall() const
{
	return (GetDamageAfterPenetrationFallOff() <= 0.0f);
}

//////////////////////////////////////////////////////////////////////////
void CCannonBall::ReInitFromPool()
{
...
//////////////////////////////////////////////////////////////////////////
bool CCannonBall::IsAlive() const
{
	return m_alive;
}

//////////////////////////////////////////////////////////////////////////
void CCannonBall::SetUpParticleParams(IEntity* pOwnerEntity, uint8 pierceabilityModifier)
{
	...
	if (m_pAmmoParams)
	{
		...
		m_cannonBallPierceability = pparams.iPierceability;
	}
...
void SDebugCannonBallPenetration::AddCannonBallHit( const Vec3& hitPosition, const Vec3& hitDirection, float currentDamage, int8 surfacePierceability, bool isBackFace, bool stoppedCannonBall, bool tooThick )
{
	if (m_nextHit == MAX_DEBUG_CannonBall_HITS)
	{
		m_nextHit = 0;
	}

	m_hitsList[m_nextHit].hitPosition = hitPosition;
	m_hitsList[m_nextHit].CannonBallDirection = hitDirection;
	m_hitsList[m_nextHit].damage = currentDamage;
	m_hitsList[m_nextHit].isBackFaceHit = isBackFace;
	m_hitsList[m_nextHit].stoppedCannonBall = stoppedCannonBall;
	m_hitsList[m_nextHit].tooThick = tooThick;
	m_hitsList[m_nextHit].surfacePierceability = surfacePierceability;
	m_hitsList[m_nextHit].lifeTime = (g_pGameCVars->g_bulletPenetrationDebugTimeout > 0.0f) ? g_pGameCVars->g_bulletPenetrationDebugTimeout : DEFAULT_DEBUG_CannonBall_HIT_LIFETIME;
...
//////////////////////////////////////////////////////////////////////////
const char* SDebugCannonBallPenetration::GetPenetrationLevelByPierceability( int8 surfacePierceability ) const
{
