...
struct SMountParams
{
	...
	void Reset()
	{
		...
		//HoO
		shoot_sound_fp.clear();
		shoot_sound_tp.clear();
		shoot_recoil_anim.clear();
		shoot_sound_override = false;
		//End HoO
	}
	...
	//HoO
	ItemString  shoot_sound_fp;
	ItemString  shoot_sound_tp;
	ItemString  shoot_recoil_anim;
	bool        shoot_sound_override;
	//End HoO
};
